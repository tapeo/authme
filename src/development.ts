...
start(app as any, {
    ...
    google_auth: {
        ...
        generic_error_redirect_uri: process.env.GOOGLE_GENERIC_ERROR_REDIRECT_URL!,
        login_error_redirect_uri: process.env.GOOGLE_LOGIN_ERROR_REDIRECT_URL!,
        signup_error_redirect_uri: process.env.GOOGLE_SIGNUP_ERROR_REDIRECT_URL!,
